...
# Parámetros D-H:
#        1        2      2p     3       4        51              52           6
d  = [ p[0],      0,     0 ,    p[2],      0 ,           2,            -2,     0 ]
th = [ p[1],      0,     90,    p[3],   p[3] ,  -p[4] - 90,     p[4] + 90,     0 ]
a  = [    0,      5,     0 ,      0 ,      0 ,           0,             0,     2 ]
...
muestra_origenes([o00,o10,o20, o30, o40, [[o510], [o520]], o60])
muestra_robot   ([o00,o10,o20, o30, o40, [[o510], [o520]], o60])
input()
